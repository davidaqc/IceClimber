...
public class Menu extends BasicGameState {
    ...
    static {
    	JUGADOR1 = new Punto(70.0f, 190.0f);
    	JUGADOR2 = new Punto(70.0f, 240.0f);
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        this.botonJugador2 = new Sprite("res/imagenes/player2.png", new Punto(120.0f, 250.0f));
        this.botonJugador3 = new Sprite("res/imagenes/player3.png", new Punto(120.0f, 300.0f));
